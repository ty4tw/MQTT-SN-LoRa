...
void SX1276StopTxTimeoutTimer(void)
{
...
void SX1276SetSyncword( uint8_t syncword )
{
	...
	SX1276.Settings.LoRa.Syncword = syncword;
}

void SX1276ReSetSyncword( void )
{
	SX1276SetModem( MODEM_LORA );
...
{
    return DEVICE_TCXO_WAKEUP_TIME + RADIO_WAKEUP_TIME;
}
