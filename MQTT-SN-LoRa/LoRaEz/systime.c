...
/*!
 * Buffer of LocalTime with string
 */
static char SysTimeStrLocalTime[128];

static int SysTimeTimeZone = 0;
...
void SysTimeSetTimeZone(int hour)
{
	SysTimeTimeZone = hour;
}
